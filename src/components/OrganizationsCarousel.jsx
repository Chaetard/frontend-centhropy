                    ...
                    {duplicatedTestimonials.map((item, idx) => (
                        ...
                        >
                            <div className="flex justify-between items-start mb-12">
                                ...
                                <div className="bg-transparent px-6 py-4 rounded-none border border-[#222944] dark:border-[#BCC5DC]/20 flex items-center justify-center min-w-[150px] h-[65px]">
                                    <img
                                        src={item.companyLogo}
                                        alt={`${item.author} Company Logo`}
                                        className="max-h-full max-w-full w-auto h-auto block object-contain dark:invert dark:brightness-150 dark:opacity-80"
                                        onError={(e) => {
